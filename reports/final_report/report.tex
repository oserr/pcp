...
%   \label{fig:mapInsertHeavy_1}
% \end{subfigure}%
% \\ % ----- second row
% \begin{subfigure}{1.0\textwidth}
%   \centering
%   \includegraphics[width=1.0\linewidth]{figs/patricio/latedays/lookups_heavy.jpg}
%   \label{fig:mapLookupHeavy_1}
% \end{subfigure}
% \caption{
% Concurrent list speedup with $N=100000$ and different use-profiles.
% \ref{fig:mapInsertHeavy_1} has a use-profile of 80\% inserts, 10\% removals, and
% 10\% lookups. \ref{fig:mapLookupHeavy_1} has a use-profile of 10\% inserts, 10\%
% removals, and 80\% lookups.
% }
% \label{fig:mapsAnalyzed}
% \end{figure}
...
% run a test with large high load factor

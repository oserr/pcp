...
Table~\ref{table:schedule}. The schedule includes four weeks, but can also be
...
is to have coarse-grain locks tasks by the first checkpoint, fine-grain locks
...
with a star, are tasks that we would be nice to accomplish, but it is unlikely
that we'll get to them.

...
4/9      & Project proposal \\
         & Doubly linked list with coarse-grained locks \\
         & Regression unit tests for linked lists \\
4/16     & Hash map with coarse-grained locks
         & Check point 1 \\
         & Doubly linked-list with fine-grained locks \\
         & Hash map with fined-grained locks \\
         & Benchmarking harness \\
4/23     & Check point 2 \\
         & Lock-free doubly-linked list \\
         & Lock-free hash map \\
         & Benchmark for Java ConcurrentLinkedDeque \\
4/30     & Benchmark for Java ConcurrentHashMap \\
         & Report \\
...
last two items indicate \textit{nice-to-haves}, but we are not commiting to
them.
}
\label{table:shedule}
\end{center}
